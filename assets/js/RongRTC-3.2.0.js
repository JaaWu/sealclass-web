...
(function (global, factory) {
  ...
  */
  ...
  var getLiveHeaders = function getLiveHeaders(im, options) {
  ...
  var LiveStream = function () {
    ...
    createClass(LiveStream, [{
      ...
      value: function getRTCToken() {
        ...
        return im.getRTCTokenAsyn(clientId);
      }
    }, {
      key: 'setPC',
      value: function setPC() {
        ...
        pc.on(PeerConnectionEvent.REMOVED, function (error) {
          if (error) {
            throw error;
          }
        });
